...
ARG PTA_URL_ARM64="https://gitcode.com/Ascend/pytorch/releases/download/v26.0.0-pytorch2.10.0/torch_npu-2.10.0.post4-cp311-cp311-manylinux_2_28_aarch64.whl"
ARG PTA_URL_AMD64="https://gitcode.com/Ascend/pytorch/releases/download/v26.0.0-pytorch2.10.0/torch_npu-2.10.0.post4-cp311-cp311-manylinux_2_28_x86_64.whl"
...
RUN if [ "$TARGETARCH" = "arm64" ]; then \
      ${PIP_INSTALL} memfabric-zbal==1.1.0; \
    fi
